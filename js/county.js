/**************************************/
/*	Plugin: County(jQuery count down plugin)
/* 	Auther: Muhammad Shahbaz Saleem
/*  Web: http://www.egrappler.com
/*	License: http://www.egrappler.com/license
/***************************************/
(function ($) {
    $.fn.county = function (options) {
        var settings = $.extend({ endDateTime: new Date(), animation: 'fade', reflection: true, reflectionOpacity: 0.2, speed: 500, theme: 'black',calculateWidth:true }, options);
